...
const projectsData = {
  ...
  instans: {
    ...
    image: "https://i.ibb.co/JRtFvVD2/Airbrush-image-extender-1.jpg", // You may want to update this with an Instans-specific image
    viewSiteLink: "https://instans.netlify.app/" // Update with actual deployment URL if available
  },
  eventMania: {
    title: "Event Mania",
