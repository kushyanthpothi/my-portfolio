...
// Metadata for better SEO (this would normally be in a separate metadata export for App Router)
export const projectsMetadata = {
  title: "Projects | Kushyanth Pothineni - Software Developer",
  description: "Explore the portfolio of projects developed by Kushyanth Pothineni, including Event Mania (event management platform), Pro Reader (Android QR code app), Pin Noter (note-taking app), and YouTube Downloader (media download tool).",
  keywords: "Kushyanth Pothineni projects, Event Mania, Pro Reader, Pin Noter, YouTube Downloader, React projects, Django projects, Android apps, portfolio projects",
  openGraph: {
    title: "Projects | Kushyanth Pothineni - Software Developer",
    ...
    images: [
      {
        ...
        width: 800,
        height: 600,
        alt: "Kushyanth Pothineni Projects Portfolio"
      }
    ]
  }
};
