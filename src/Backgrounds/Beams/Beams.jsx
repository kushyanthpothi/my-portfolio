...
const Beams = ({
  ...
  // Theme colors mapping from Fireworks component
  const themeColors = {
  ...
  // Select background and light colors based on mode
  const backgroundColor = isDarkMode ? '#000000' : '#000000'; // Black in dark mode, white in light mode
  const lightColor = isDarkMode ? colors[0] : colors[0]; // Use primary theme color for light in both modes
