...
export const fetchProjects = async (forceRefresh = false) => {
    ...
    try {
        ...
        // Sort by createdAt descending (newest first). Fallback to ID descending.
...
export const addProject = async (projectData) => {
    try {
        ...
        await setDoc(doc(db, "projects", slug), {
            id: projectData.id || Date.now(), // Generate numerical ID if missing
            slug: slug, // Ensure slug stays synced inside the database schema as well!
            ...projectData,
