...
module.exports = {
  ...
  safelist: [
    ...
    'dark:border-blue-400', 'dark:border-red-400', 'dark:border-purple-400', 'dark:border-emerald-400', 'dark:border-orange-400', 'dark:border-pink-400',
    ...
    'bg-blue-100', 'bg-red-100', 'bg-purple-100', 'bg-emerald-100', 'bg-orange-100', 'bg-pink-100',
    'hover:bg-blue-200', 'hover:bg-red-200', 'hover:bg-purple-200', 'hover:bg-emerald-200', 'hover:bg-orange-200', 'hover:bg-pink-200',
  ],
